...
#
# Create Service principal to be used by GitHub Actions in bicep deployments
#
...
# Output
echo "========================================================================================="
echo "Add the above JSON into a GitHub Actions secret named AZURE_ENVIRONMENT_RBAC_CREDENTIALS."
echo "========================================================================================="
